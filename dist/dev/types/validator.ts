...
// Validate ../../../app/api/mcp.json/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/mcp.json">> = Specific
  const handler = {} as typeof import("../../../app/api/mcp.json/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/process-mdx/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/process-mdx">> = Specific
  const handler = {} as typeof import("../../../app/api/process-mdx/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
